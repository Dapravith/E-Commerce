<template>
  ...
  <div class="wrapper">
    ...
    <div class="feature-box">
        <div class="picture">
          <img src="https://img.freepik.com/premium-vector/macbook-pro-2021-macbook-pro-m1-pro-macbook-pro-m1-max-vector-set-mock-up-realistic-laptop-zaporizhzhia-ukraine-october-19-2021_399089-3244.jpg?size=626&ext=jpg&ga=GA1.2.1544568529.1684157972&semt=ais" alt="">
        </div>
        <div class="text">
          <h2>New Model</h2>
          <p>Pre-Order Now or Shop Now</p><br><br>
          <h2>Price : <span style="color: rgb(44, 187, 170);">$1199</span></h2><br><br><br>
          <button class="pre-order-btn"><i class="fas fa-clock"></i> Pre-Order</button>
        <button class="shop-now-btn"><i class="fas fa-shopping-cart"></i> Shop Now</button>
        </div>
      </div>
    ...
    <footer>
      <div class="footer-container container">
        ...
        <div class="content_2">
            <h4>SHOPPING</h4>
            <a href="#sellers">Computer Store</a>
            <a href="#sellers">Trending PC</a>
